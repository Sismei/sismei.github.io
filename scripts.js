...
// constants
const prompt = `<span class="user">root@sismei</span><span class="symbols">:</span><span class="directory">~</span><span class="symbols">$</span>&nbsp;`;

const files = {
    'about_me.txt': `hi, I am Sismei and I am 17.<br>i like listening to music, fun and programming.<br>isn't that enough?`,
    'social.txt': `["<a target="_blank" href="https://github.com/sismei">github</a>", "<a target="_blank" href="https://open.spotify.com/user/31pwdp44ozorxnxtvxipbayzu6om?si=f1bb5b87ab5f4132">spotify</a>", "<a target="_blank" href="https://discord.com/users/298158368407683073">discord</a>"]`
}
